@php
    ...
    $route = $isEdit ? route('rts.update', $rts->id) : route('rts.store');
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <label for="first-name-vertical">Rukun Tetangga</label>
                        <input type="number" id="first-name-vertical" class="form-control" name="rt" value="{{ $isEdit ? $rts->rt : '' }}"
